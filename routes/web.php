...
Route::get('/forgot-password', [PasswordController::class, 'viewForgot'])->name('password.email')->middleware('guest');
Route::post('/forgot-password', [PasswordController::class, 'forgotPassword'])->name('password.email')->middleware('guest');

Route::get('/reset-password/{token}', [PasswordController::class, 'viewReset'])->name('password.reset')->middleware('guest');
...
Route::put('/category/{id}', [CategoryController::class, 'update'])->name('update.category')->middleware('auth');
Route::delete('/category/{id}', [CategoryController::class, 'delete'])->name('delete.category')->middleware('auth');
...
Route::put('/type/{id}', [TypeController::class, 'update'])->name('update.type')->middleware('auth');
Route::delete('/type/{id}', [TypeController::class, 'delete'])->name('delete.type')->middleware('auth');
...
Route::put('/subtype/{id}', [FamilyController::class, 'update'])->name('update.family')->middleware('auth');
Route::delete('/subtype/{id}', [FamilyController::class, 'delete'])->name('delete.family')->middleware('auth');
...
Route::put('/account/{id}', [AccountController::class, 'update'])->name('update.account')->middleware('auth');
Route::delete('/account/{id}', [AccountController::class, 'delete'])->name('delete.account')->middleware('auth');
...
Route::put('/spent/{i}', [SpentController::class, 'update'])->name('update.spent')->middleware('auth');
Route::delete('/spent/{i}', [SpentController::class, 'delete'])->name('delete.spent')->middleware('auth');
...
Route::put('/car/{id}', [CarController::class, 'update'])->name('update.car')->middleware('auth');
Route::delete('/car/{id}', [CarController::class, 'delete'])->name('delete.car')->middleware('auth');
...
Route::put('/fuel/{id}', [FuelController::class, 'update'])->name('update.fuel')->middleware('auth');
Route::delete('/fuel/{id}', [FuelController::class, 'delete'])->name('delete.fuel')->middleware('auth');
