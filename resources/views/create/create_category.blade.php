        ...
        <table class="table-container table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
            ...
            @foreach($categories as $category)
                <tr>
                    ...
                    <th>
                        <button type="submit" id="delete" class="button is-danger"><a class="has-text-light" href="{{ url('/create/category_delete?category_id='. $category->id) }}" ><span class="icon"><i class="fas fa-trash-alt"></i></span></a></button>
                    </th>
                </tr>
                <!-- Modal Card -->
                            ...
                            <form method="POST" action="{{route('update_category')}}">
                                ...
                                <div class="card-content">
                                    <div class="mb-5">
                                        ...
                                        <input id="category_id" name="category_id" class="is-hidden" value="{{ $category->id }}">
